...
class Repeat():
    ...
    def __init__(self):
        ...
        self.count = [211,212,213,214,215,216,217,218,219,220]
        # self.count = [221,222,223,224,225,226,227,228,229,230]
    ...
    def simulation_setup(self):
        ...
        self.launch_simulation = roslaunch.parent.ROSLaunchParent(self.uuid, [self.agent_path + "/launch/small_complex_world_6.launch"] )
    ...
    def configuration(self):
        ...
        while True:
            if spawned:
                ...
                spawned = Respawn_model()
        self.launch_velocity = roslaunch.parent.ROSLaunchParent(uuid, [self.object_localizer_path + "/launch/run_vel_co_6.launch"])
